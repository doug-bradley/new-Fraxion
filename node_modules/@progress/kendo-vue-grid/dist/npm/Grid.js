...
var GridVue2 = {
  ...
  render: function render(createElement) {
    ...
    var dataRow = function dataRow(item, rowId, rowDataIndex) {
      ...
      var selectedValue = selectedField ? (0, kendo_vue_common_1.getNestedValue)(selectedField, item.dataItem) : undefined;
      return {
        row: this._columns.map(function (column, index) {
          ...
          if (column.editable && this.$props.editField) {
            var inEdit = (0, kendo_vue_common_1.getNestedValue)(this.$props.editField, item.dataItem);
