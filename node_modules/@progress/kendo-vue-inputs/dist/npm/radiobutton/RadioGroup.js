...
exports.RadioGroupVue2 = exports.RadioGroup = void 0;
// @ts-ignore
var Vue = require("vue");
var allVue = Vue;
var gh = allVue.h;
...
var RadioGroupVue2 = {
  ...
  created: function created() {
    this.radioGroupName = (0, kendo_vue_common_1.guid)();
  ...
  mounted: function mounted() {
    this.rtl = (0, kendo_vue_common_1.isRtl)(this.$el);
  },
  computed: {
    ...
    var radioOptions = dataItems && dataItems.map(function (option, index) {
      ...
      return (
        ...
        h(RadioButton_1.RadioButton, {
          "class": (0, kendo_vue_common_1.classNames)('k-radio-item', {
